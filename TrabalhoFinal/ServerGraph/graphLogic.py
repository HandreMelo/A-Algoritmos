...
def ler_arquivo(file):
    ...
    try:
        ...
        print("valor numÃ©rico invÃ¡lido")
    except IndexError:
        print("matriz do arquivo nÃ£o estÃ¡ no tamanho correto")
    except FileNotFoundError:
        print("NÃ£o encontrado arquivo especificado")
...
def limpar_formatacao_arquivo_lido(vetor_ler):
    for i in range(len(vetor_ler)):
        vetor_ler[i] = vetor_ler[i].replace("'", "").replace("â€˜", "").replace("â€™", "")
    return vetor_ler
